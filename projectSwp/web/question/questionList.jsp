                ...
                <tbody>
                    <c:forEach var="q" items="${questionList}">
                        <tr>
                            ...
                            <td>
                                <c:forEach var="img" items="${images}">
                                    <c:if test="${img.id == q.image_id}">
                                        <img src="data:image/jpg;base64, ${img.image_data}" alt="Question Image" width="100" height="100" class="img-thumbnail">
                                    </c:if>
                                </c:forEach>
                            </td>
                            <td>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${fn:contains(q.question, 'AI-generated') || fn:contains(q.question, 'Generated by AI')}">
