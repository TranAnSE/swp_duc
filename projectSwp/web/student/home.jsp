            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value">${dashboardData.studentStats.avgScore}%</div>
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value">${dashboardData.studentStats.bestScore}%</div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-right">
                                            <c:if test="${activity.score != null}">
                                                <div class="font-weight-bold text-primary">${activity.score}%</div>
                                            </c:if>
