...
<head>
    ...
    <style>
        ...
        .stats-icon.students { background-color: #e3f2fd; color: #1976d2; }
        .stats-icon.grades { background-color: #f3e5f5; color: #7b1fa2; }
        .stats-icon.subjects { background-color: #e8f5e8; color: #388e3c; }
        .stats-icon.lessons { background-color: #fff3e0; color: #f57c00; }
        .stats-icon.tests { background-color: #fce4ec; color: #c2185b; }
                                                ...
                                                <div class="activity-item">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <div class="text-muted small">
                                                            ...
                                                            <span class="badge badge-${activity.score >= 70 ? 'success' : activity.score >= 50 ? 'warning' : 'danger'} ml-1">
                                                                ${activity.score}%
                                                            </span>
                                                        </div>
