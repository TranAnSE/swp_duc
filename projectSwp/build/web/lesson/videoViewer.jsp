...
<head>
    ...
    <style>
        ...
        .grade-header.collapsed i.fa-chevron-down {
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.lesson-item.active').parents('.collapse').prev('.grade-header, .subject-header, .chapter-header')
                .removeClass('collapsed').find('.fa-chevron-down').removeClass('collapsed');
            ...
            // Collapse/Expand animations with icons
            ...
            function adjustForMobile() {
                if ($(window).width() < 768) {
                    ...
                    $('.course-sidebar .collapse').removeClass('show');
                    $('.course-sidebar .fa-chevron-down').addClass('collapsed');
                }
            }
