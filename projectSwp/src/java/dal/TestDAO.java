...
public class TestDAO extends DBContext {
    ...
    public List<Map<String, Object>> getAllTestsWithPaginationAndFilters(
            String searchKeyword, String testType, Integer courseId, int page, int pageSize) {
    ...
    public int getTotalTestsCountForAdmin(String searchKeyword, String testType, Integer courseId) {
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT COUNT(DISTINCT t.id) ");
        sql.append("FROM test t ");
        sql.append("LEFT JOIN study_package sp1 ON t.course_id = sp1.id ");
    ...
    public List<Map<String, Object>> getAllCoursesForAdmin() {
        ...
        String sql = """
        SELECT DISTINCT sp.id as course_id, sp.course_title, sp.approval_status, sp.is_active,
